...
import cordaCode.core.flows.FinalityFlow;
import cordaCode.core.flows.FlowLogic;
import cordaCode.core.flows.InitiatedBy;
import cordaCode.core.flows.InitiatingFlow;
import cordaCode.core.flows.ReceiveFinalityFlow;
...
import cordaCode.core.node.services.vault.PageSpecification;
...
//                    subFlow(new DigitalShell.flows.FinalityFlow(signedTransaction, ImmutableList.of(issuerSession)))
                return "Success";
            }else {
//                    DigitalShell.flows.FinalityFlow finalityFlow = new DigitalShell.flows.FinalityFlow(signedTransaction,ImmutableList.of(issuerSession, receiverSession));
                time_manager.cut("9");
