...
class TransactionBuilder(
    ...
    private fun attachmentConstraintsTransition(
        ...
        constraints.any { it is WhitelistedByZoneAttachmentConstraint } &&
                ...
                services.networkParameters.minimumPlatformVersion >= PlatformVersionSwitches.ENABLE_P2P_COMPRESSION ->
    ...
    fun checkNotary(stateAndRef: StateAndRef<*>) {
...
//            "Input state requires notaryhh \"${notary.description()}\" which does not match" +
