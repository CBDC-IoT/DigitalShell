...
import cordaCode.core.crypto.CompositeKey
...
import cordaCode.core.node.ZoneVersionTooLowException
import cordaCode.core.node.services.AttachmentId
import cordaCode.core.node.services.KeyManagementService
...
import cordaCode.core.transactions.MissingContractAttachments
...
open class TransactionBuilder(
    ...
    private companion object {
        ...
        private val MISSING_CLASS_DISABLED = java.lang.Boolean.getBoolean("cordaCode.transactionbuilder.missingclass.disabled")
        ...
        */
        ...
        val hashAttachments = inputsAndOutputs
                ...
                .map { state ->
                    ...
                    if (attachment == null || attachment !is ContractAttachment || !cordaCode.core.internal.isUploaderTrusted(attachment.uploader)) {
