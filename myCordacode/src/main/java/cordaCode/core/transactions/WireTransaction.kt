...
import cordaCode.core.contracts.ComponentGroupEnum.COMMANDS_GROUP
import cordaCode.core.contracts.ComponentGroupEnum.OUTPUTS_GROUP
import cordaCode.core.crypto.*
...
class WireTransaction(componentGroups: List<ComponentGroup>, val privacySalt: PrivacySalt = PrivacySalt()) : TraversableTransaction(componentGroups) {
    ...
    private val missingAttachment: Attachment by lazy {
        object : AbstractAttachment({ byteArrayOf() }, cordaCode.core.internal.DEPLOYED_CORDAPP_UPLOADER) {
