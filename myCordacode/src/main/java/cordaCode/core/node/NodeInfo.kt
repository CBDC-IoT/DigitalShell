 ...
 * cache, accessible from a [cordaCode.core.node.services.NetworkMapCache]. They are also available via RPC
 * using the [cordaCode.core.messaging.CordaRPCOps.networkMapSnapshot] method.
 *
