...
import cordaCode.core.cordapp.CordappContext
...
import cordaCode.core.node.services.*
import cordaCode.core.node.services.diagnostics.DiagnosticsService
import cordaCode.core.serialization.SerializeAsToken
import cordaCode.core.transactions.FilteredTransaction
...
interface ServiceHub : ServicesForResolution {
     ...
     * If the [PublicKey] is actually a [cordaCode.core.crypto.CompositeKey] the first leaf key found locally will be used
     * for signing.
     ...
     * [cordaCode.core.schemas.QueryableState]).
     *
