 ...
 * Subscription can be performed using [cordaCode.core.node.AppServiceHub.register] method from a constructor of [CordaService].
 */
@FunctionalInterface
...
enum class ServiceLifecycleEvent {
    /**
     * This event is dispatched when State Machine is fully started such that [cordaCode.core.node.AppServiceHub] available
