...
import cordaCode.core.contracts.TransactionVerificationException.OverlappingAttachmentsException
import cordaCode.core.contracts.TransactionVerificationException.PackageOwnershipException
import cordaCode.core.crypto.SecureHash
import cordaCode.core.crypto.sha256
import cordaCode.core.internal.*
import cordaCode.core.internal.cordapp.targetPlatformVersion
import cordaCode.core.node.NetworkParameters
import cordaCode.core.serialization.*
import cordaCode.core.serialization.internal.AttachmentURLStreamHandlerFactory.toUrl
...
class AttachmentsClassLoader(attachments: List<Attachment>,
    ...
    private fun shouldCheckForNoOverlap(path: String, targetPlatformVersion: Int): Boolean {
        ...
        return when {
            ...
            (path == "meta-inf/services/cordaCode.core.serialization.serializationwhitelist") -> false // Allow overlapping on the SerializationWhitelist.
