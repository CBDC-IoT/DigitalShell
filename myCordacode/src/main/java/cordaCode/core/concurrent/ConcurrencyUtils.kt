...
package cordaCode.core.concurrent

import cordaCode.core.internal.concurrent.OpenFuture
...
private val defaultLog = LoggerFactory.getLogger("cordaCode.core.concurrent")
@VisibleForTesting
