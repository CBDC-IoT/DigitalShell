...
open class OpaqueBytes(bytes: ByteArray) : ByteSequence(bytes, 0, bytes.size) {
     ...
     * to prevent tampering with entities such as [cordaCode.core.crypto.SecureHash] and [cordaCode.core.contracts.PrivacySalt], as well as
     * preserve the integrity of our hash constants [cordaCode.core.crypto.SecureHash.zeroHash] and [cordaCode.core.crypto.SecureHash.allOnesHash].
     *
