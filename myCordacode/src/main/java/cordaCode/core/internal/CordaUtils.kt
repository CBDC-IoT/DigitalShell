...
import cordaCode.core.cordapp.CordappProvider
import cordaCode.core.flows.DataVendingFlow
...
import cordaCode.core.node.services.AttachmentStorage
import cordaCode.core.node.services.vault.AttachmentQueryCriteria
import cordaCode.core.node.services.vault.AttachmentSort
import cordaCode.core.node.services.vault.Builder
import cordaCode.core.node.services.vault.Sort
...
fun AttachmentStorage.internalFindTrustedAttachmentForClass(className: String): Attachment? {
    val allTrusted = queryAttachments(
            AttachmentQueryCriteria.AttachmentsQueryCriteria().withUploader(Builder.`in`(cordaCode.core.internal.TRUSTED_UPLOADERS)),
