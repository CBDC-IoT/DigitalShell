package cordaCode.core.contracts

import cordaCode.core.DoNotImplement
import cordaCode.core.KeepForDJVM
import cordaCode.core.contracts.AlwaysAcceptAttachmentConstraint.isSatisfiedBy
...
import cordaCode.core.utilities.loggerFor
...
data class HashAttachmentConstraint(val attachmentId: SecureHash) : AttachmentConstraint {
    companion object {
        val disableHashConstraints = System.getProperty("cordaCode.node.disableHashConstraints")?.toBoolean() ?: false
    }
 ...
 * See: [cordaCode.core.node.NetworkParameters.whitelistedContractImplementations]
