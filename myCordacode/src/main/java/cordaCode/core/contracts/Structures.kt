...
import cordaCode.core.crypto.secureRandomBytes
import cordaCode.core.crypto.toStringShort
import cordaCode.core.flows.FlowLogicRef
import cordaCode.core.flows.FlowLogicRefFactory
 ...
 *
 * Note the use of [FlowLogicRef] to represent a safe way to transport a [cordaCode.core.flows.FlowLogic] out of the
 * contract sandbox.
 *
 ...
 * every [cordaCode.core.transactions.LedgerTransaction] they see on the network, for every input and output state. All
