package cordaCode.core.messaging
...
import cordaCode.core.flows.FlowInitiator
import cordaCode.core.flows.FlowLogic
import cordaCode.core.flows.StateMachineRunId
...
import cordaCode.core.node.NodeDiagnosticInfo
import cordaCode.core.node.NodeInfo
import cordaCode.core.node.services.AttachmentId
import cordaCode.core.node.services.NetworkMapCache
import cordaCode.core.node.services.Vault
import cordaCode.core.node.services.VaultQueryException
import cordaCode.core.node.services.vault.*
import cordaCode.core.serialization.CordaSerializable
import cordaCode.core.transactions.SignedTransaction
import cordaCode.core.utilities.Try
...
interface CordaRPCOps : RPCOps {
     ...
     * with [cordaCode.core.flows.StartableByRPC].
     */
    @RPCReturnsObservables
     ...
     * result of running the flow. [logicType] must be annotated with [cordaCode.core.flows.StartableByRPC].
     */
    @RPCReturnsObservables
