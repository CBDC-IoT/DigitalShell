...
import cordaCode.core.flows.ReceiveTransactionFlow
...
import cordaCode.core.identity.groupPublicKeysByWellKnownParty
 ...
 *
 * Example - checking and signing a transaction involving a [cordaCode.core.contracts.DummyContract], see
