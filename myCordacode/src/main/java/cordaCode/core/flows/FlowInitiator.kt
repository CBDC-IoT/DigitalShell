...
import cordaCode.core.context.Actor
import cordaCode.core.context.AuthServiceId
import cordaCode.core.context.InvocationContext
import cordaCode.core.context.InvocationOrigin
import cordaCode.core.contracts.ScheduledStateRef
...
/**
 * Please note that [FlowInitiator] has been superceded by [cordaCode.core.context.InvocationContext], which offers
...
sealed class FlowInitiator : Principal {
    /** Started using [cordaCode.core.messaging.CordaRPCOps.startFlowDynamic]. */
     ...
     * prefer to use fetch an invocation context directly if you can (e.g. in [cordaCode.core.messaging.StateMachineInfo])
     */
